...
public class MappingValuesHibernateTest {
    ...
    private static SessionFactory createSessionFactory() {
        ...
        configuration.configure().addPackage("com.manning.javapersistence.ch06.converter").addAnnotatedClass(User.class).addAnnotatedClass(Item.class).addAnnotatedClass(Bid.class);
